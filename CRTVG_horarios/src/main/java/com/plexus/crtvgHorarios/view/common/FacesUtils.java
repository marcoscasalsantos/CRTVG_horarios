package com.plexus.crtvgHorarios.view.common;
...
import com.plexus.crtvgHorarios.service.common.Constantes;


public class FacesUtils {
	
	private static String resourceBundleName = Constantes.RESOURCE_BUNDLE_NAME;
	...
	/**
	 * Flash scope it is automatically destroyed once the second view is completed
	 * 
	 * Se puede acceder programaticamente como muestra este metodo o en la pagina .xhtml mediante #{flash.attribute}
	 * 
	 * There is a way to make data in Flash scope alive a bit longer. 
	 * It is enough if in page.xhtml we change #{flash.text} to #{flash.keep.text}. 
	 * This way data is not removed from the scope after first request, but is available for one more.
	 * 
	 */  
	public static void putFlashAttribute(String name, Object value) {
